...
function handleSearchFunctionality(){
    ...
    .addEventListener("input", function(){
        ...
        //Here This Line will show only search related posts
        showTheCards(filteredArray)

        //This code displays search-history-like stuff OR related seaches
        var clutter = "";
        ...
        //this line display(unhide) the realted search div
        document.querySelector(".searchdata").style.display = "block";
        //this line adds the related search data in search div
        document.querySelector(".searchdata").innerHTML = clutter;
    })
}

handleSearchFunctionality();
//this functions displays all posts(objects)
showTheCards(arr);
